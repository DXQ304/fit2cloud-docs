...
<img alt="仪表板_富文本组件入口" src="/img/dataease-v2/dashboard_generation/2.0富文本组件点击.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>

<img alt="富文本组件_功能" src="/img/dataease-v2/dashboard_generation/2.0富文本组件.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
:::
...
<img alt="富文本组件_调整样式" src="/img/dataease-v2/dashboard_generation/2.0富文本样式调整.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>

:::note

点击插入超链接按钮，可配置超链接，下示例图以插入”百度网页“链接为例。

<img alt="富文本组件_超链接" src="/img/dataease-v2/dashboard_generation/2.0超链接设置.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
:::
...
<img alt="富文本组件_表格" src="/img/dataease-v2/dashboard_generation/2.0富文本表格.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>

<img alt="富文本组件_表格" src="/img/dataease-v2/dashboard_generation/2.0富文本表格属性设置.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="富文本组件_图片" src="/img/dataease-v2/dashboard_generation/2.0富文本插入图片或者媒体.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>

<img alt="富文本组件_媒体" src="/img/dataease-v2/dashboard_generation/2.0富文本插入媒体.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="仪表盘编辑_其他组件" src="/img/dataease-v2/dashboard_generation/仪表板图片组件.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>

<img alt="仪表盘编辑_其他组件" src="/img/dataease-v2/dashboard_generation/2.0点击上传图片.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="仪表盘编辑_其他组件" src="/img/dataease-v2/dashboard_generation/仪表板流媒体组件.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="仪表盘编辑_其他组件" src="/img/dataease-v2/dashboard_generation/2.0Tab组件.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>

<img alt="Tab页展示视图" src="/img/dataease-v2/dashboard_generation/2.0选择tab1.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
