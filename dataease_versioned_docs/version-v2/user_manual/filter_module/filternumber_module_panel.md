...
<img alt="数字下拉组件入口" src="/img/dataease-v2/dashboard_generation/数据大屏数字下拉.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>  
<img alt="仪表盘编辑_过滤组件" src="/img/dataease-v2/dashboard_generation/数据大屏数字筛选.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>  
