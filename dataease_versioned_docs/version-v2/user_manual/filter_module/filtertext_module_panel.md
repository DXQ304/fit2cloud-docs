...
<img alt="文本下拉组件入口" src="/img/dataease-v2/dashboard_generation/数据大屏文本下拉.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>  
<img alt="仪表盘编辑_过滤组件" src="/img/dataease-v2/dashboard_generation/数据大屏文本过滤.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
- 搜索模式：精确匹配、模糊匹配
:::
<img alt="更新1" src="/img/dataease-v2/dashboard_generation/数据大屏文本搜索.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
<img alt="更新1" src="/img/dataease-v2/dashboard_generation/数据大屏文本搜索匹配模式.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
<img alt="更新1" src="/img/dataease-v2/dashboard_generation/数据大屏文本模糊搜索.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="更新1" src="/img/dataease-v2/newimg/数据大屏查询组件支持配置外部显示或隐藏精确匹配和模糊匹配.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
:::
<img alt="更新1" src="/img/dataease-v2/newimg/下拉树添加层级.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
<img alt="更新1" src="/img/dataease-v2/newimg/下拉树效果.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
