...
<img alt="数字下拉组件入口" src="/img/dataease-v2/dashboard_generation/2.0设置数字下拉组件.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>  
<img alt="仪表盘编辑_过滤组件" src="/img/dataease-v2/dashboard_generation/2.0数字下拉结果.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>  
