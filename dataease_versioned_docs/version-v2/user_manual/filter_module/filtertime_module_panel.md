...
<img alt="年份组件入口" src="/img/dataease-v2/dashboard_generation/数据大屏过滤组件年.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>  
<img alt="仪表盘编辑_过滤组件" src="/img/dataease-v2/dashboard_generation/数据大屏过滤组件筛选年.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>  
...
<img alt="年份组件入口" src="/img/dataease-v2/dashboard_generation/数据大屏过滤组件年月.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>  
<img alt="仪表盘编辑_过滤组件" src="/img/dataease-v2/dashboard_generation/数据大屏过滤组件筛选年月.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="年份组件入口" src="/img/dataease-v2/dashboard_generation/数据大屏过滤组件年月日.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>  
<img alt="仪表盘编辑_过滤组件" src="/img/dataease-v2/dashboard_generation/数据大屏年月日筛选.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>

:::note

日期过滤组件支持时分秒级别的设置。
:::
<img alt="年份组件入口" src="/img/dataease-v2/dashboard_generation/数据大屏过滤设置时分秒.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>  
...
:::
<img alt="仪表盘编辑_过滤组件" src="/img/dataease-v2/dashboard_generation/数据大屏时间范围区间设置.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
