...
<img alt="视图可选维度列表" src="/img/dataease-v2/view_generation/2.0点击样式.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
- 背景图片和边框设置。
:::
<img alt="视图可选维度列表" src="/img/dataease-v2/view_generation/2.0样式背景.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>

<img alt="视图可选维度列表" src="/img/dataease-v2/view_generation/2.0样式背景设置.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="图形属性_修改颜色" src="/img/dataease-v2/view_generation/2.0样式基础样式.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="图形属性_自定义配色" src="/img/dataease-v2/view_generation/2.0自定义配色.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>

<img alt="图形属性_自定义配色" src="/img/dataease-v2/view_generation/2.0自定义配色2.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="图形属性" src="/img/dataease-v2/view_generation/2.0自定义颜色渐变透明度.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="更新1" src="/img/dataease-v2/newimg/更新v2-4-0-6.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
<img alt="更新1" src="/img/dataease-v2/newimg/更新v2-4-0-7.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="组件样式_值与名称字体样式" src="/img/dataease-v2/view_generation/2.0样式大小.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="组件样式_AntV" src="/img/dataease-v2/view_generation/2.0指标卡大小样式.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>

:::note

词云图支持配置字号大小区间和文字间距。
:::
<img alt="更新1" src="/img/dataease-v2/newimg/仪表板词云图样式大小.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="图形属性" src="/img/dataease-v2/view_generation/2.0样式标签设置.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="组件样式_背景" src="/img/dataease-v2/view_generation/2.0提示设置.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>、
...
<img alt="组件样式_标题字体样式" src="/img/dataease-v2/view_generation/2.0标题设置.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="组件样式" src="/img/dataease-v2/view_generation/2.0图例设置.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="组件样式_设置格式化" src="/img/dataease-v2/view_generation/2.0样式坐标轴横轴.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="坐标轴轴线显示控制" src="/img/dataease-v2/view_generation/2.0坐标轴纵轴.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="组件样式_设置格式化" src="/img/dataease-v2/view_generation/表格样式设置.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="更新1" src="/img/dataease-v2/newimg/透视表展示设置.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>

<img alt="更新1" src="/img/dataease-v2/newimg/透视表展示形式.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
