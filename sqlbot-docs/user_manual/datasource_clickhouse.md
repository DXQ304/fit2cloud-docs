...
![配置 ClickHouse 连接信息](/img/sqlbot/user_manual/datasource/add_clickhouse.png)
...
![选择数据表](/img/sqlbot/user_manual/datasource/save_sqlserver.png)
...
![问数 ClickHouse](/img/sqlbot/user_manual/datasource/question_clickhouse.png)
