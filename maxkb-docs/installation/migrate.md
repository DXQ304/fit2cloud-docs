...
![migrate](/img/maxkb/index/migrate_route.png)
...
:::
![migrate](/img/maxkb/index/migrate_step.png)
...
![v1数据导出](/img/maxkb/index/migrate_linux_export.png)
...
![导入linux](/img/maxkb/index/migrate_linux_import.png)

:::note

导入成功后，需要重启 MaxKB 服务。
:::
![导入linux](/img/maxkb/index/migrate_linux_import1.png)
...
![导出windows](/img/maxkb/index/migrate_windows_export.png)
...
**注意**：v1 社区版只能迁移到 v2 社区版，v1 专业版只能迁移到 v2 专业版，且 v1 和 v2 的专业版必须有有效的 license 许可。
:::
![导出windows](/img/maxkb/index/migrate_windows_import.png)
