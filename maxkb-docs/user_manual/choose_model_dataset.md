...
<img alt="添加用户输入" src="/img/maxkb/system/add_parameter.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>
...
![设置模型参数](/img/maxkb/system/set_model.png)
...
![切换模型](/img/maxkb/system/switch_model.png)
...
<img alt="添加用户输入" src="/img/maxkb/system/add_parameter_dataset.png" width="600" style={{maxWidth:'100%', height:'auto'}}/>
...
![设置知识库参数](/img/maxkb/system/set_dataset.png)
...
![切换知识库](/img/maxkb/system/switch_dataset.png)
