...
![上传文档](/img/maxkb/dataset/document_action.png)
...
![导入Web文档](/img/maxkb/dataset/upload_web_doc.png)
...
![同步文档](/img/maxkb/dataset/sysn_dataset.png)
...
![文档设置](/img/maxkb/dataset/doc_setting.png)
...
![生成问题](/img/maxkb/dataset/gen_question.png)

![生成问题](/img/maxkb/dataset/gen_question2.png)
...
![迁移文档](/img/maxkb/dataset/move_web_doc.png)
...
![标签管理](/img/maxkb/dataset/Tag_Manage1.png)
...
![标签管理](/img/maxkb/dataset/Tag_Manage.png)
...
![标签管理](/img/maxkb/dataset/Tag_association.png)
...
![添加标签](/img/maxkb/dataset/add_tag.png)
![添加标签](/img/maxkb/dataset/add_tag1.png)
...
![标签管理](/img/maxkb/dataset/tag_setting1.png)
![标签管理](/img/maxkb/dataset/tag_setting1.png)
...
![文档导出](/img/maxkb/dataset/dataset_file_export.png)
...
![文档导出](/img/maxkb/dataset/dataset_file_export1.png)
...
![文档下载原文件](/img/maxkb/dataset/doc_down.png)
...
![文档替换原文件](/img/maxkb/dataset/replay_doc.png)
![文档替换原文件](/img/maxkb/dataset/replay_doc1.png)
...
![文档删除](/img/maxkb/dataset/doc_delete.png)
...
![文档启用](/img/maxkb/dataset/doc_enable.png)
...
![分段管理](/img/maxkb/dataset/segmentation_management.png)
...
![添加分段](/img/maxkb/dataset/add_segmentation.png)
...
![分段详情](/img/maxkb/dataset/edit_segmentation.png)
...
![迁移分段](/img/maxkb/dataset/move_segmentation.png)
...
:::
![移动位置](/img/maxkb/dataset/upanddown_segmentation.png)
...
![删除分段](/img/maxkb/dataset/del_segmentation.png)
