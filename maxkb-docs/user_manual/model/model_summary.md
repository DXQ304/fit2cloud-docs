...
![模型](/img/maxkb/model/model_view.png)
...
![模型](/img/maxkb/model/create_model.png)

:::note

支持编辑、模型参数设置、资源授权、查看关联资源和删除。
:::
![模型](/img/maxkb/model/edit_model.png)
...
![模型](/img/maxkb/model/search_model.png)
...
![模型](/img/maxkb/model/delete_model.png)
