...
![触发器](/img/maxkb/trigger/trigger.png)
...
![定时触发器](/img/maxkb/trigger/timer_trigger.png)
...
![定时触发器](/img/maxkb/trigger/timer_trigger1.png)
...
![事件触发器](/img/maxkb/trigger/webhook_trigger.png)
...
![事件触发器](/img/maxkb/trigger/webhook_trigger1.png)
...
![启用/禁用触发器](/img/maxkb/trigger/active_trigger.png)
...
![编辑触发器](/img/maxkb/trigger/edit_trigger.png)
![编辑触发器](/img/maxkb/trigger/edit_trigger1.png)
...
![执行记录](/img/maxkb/trigger/trigger_run_record.png)
...
![执行记录](/img/maxkb/trigger/trigger_run_record1.png)
...
![删除触发器](/img/maxkb/trigger/delete_trigger.png)