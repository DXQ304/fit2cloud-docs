...
:::
![对话演示](/img/maxkb/app/wechat_ai_asker.png)
...
![企微机器人配置](/img/maxkb/app/wechat_ai_add.png)
...
![创建企微机器人](/img/maxkb/app/wechat_ai_create.png)
![创建企微机器人](/img/maxkb/app/wechat_ai_create1.png)
...
![API模式创建](/img/maxkb/app/wechat_ai_API.png)
...
![回调地址](/img/maxkb/app/wechat_ai_recall.png)
...
![企业微信对话](/img/maxkb/app/enter_wechat_dialog.png)
...
![显示设置](/img/maxkb/app/ent_wechat_setting.png)
...
![企业ID](/img/maxkb/system/obtain_wxid.png)
...
![企业微信智能体设置](/img/maxkb/app/robot_info.png)
...
![企微智能体信息](/img/maxkb/system/qiwei_appinfo.png)
...
![设置API接收](/img/maxkb/app/recmsg_api.png)
...
![设置API接收](/img/maxkb/app/recmsg_api_setting.png)
...
<img alt="企业微信客服账号" src="/img/maxkb/app/dialog_cs.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>
...
![企业微信客服账号](/img/maxkb/app/weichat_customservice.png)

![企业微信客服账号](/img/maxkb/app/create_cs_account.png)
...
![企业微信客服账号](/img/maxkb/app/cs_app.png)

![企业微信客服账号](/img/maxkb/app/config_cs_account.png)
...
<img alt="企业微信客服账号" src="/img/maxkb/app/enable_cs.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>
<img alt="企业微信客服账号" src="/img/maxkb/app/dialog_cs.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>
...
:::
<img alt="公众号对话" src="/img/maxkb/app/public_account_dialog.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>

:::note

在智能体接入中点击【公众号】的【配置】按钮，配置信息中会自动生成回调 URL,并需要复制到【微信公众平台-设置与开发-基本配置-服务器配置】服务器地址 URL 中，除此之外的其它信息，将在微信公众平台中生成并获取。
:::
![公众号配置](/img/maxkb/app/public_account_setting_empty.png)

:::note

获取 APP ID、APP Secret、Token 和消息加解密密钥：在微信公众平台-设置与开发-基本配置中获取 APP ID、APP Secret 信息，并启动服务器配置，生成 Token 和消息加解密密钥。
:::
![公众号信息](/img/maxkb/app/public_account_basicinfo.png)
![公众号信息](/img/maxkb/app/public_account_setting1.png)

:::note

将生成的 APP ID、APP Secret、Token 和消息加解密密钥信息输入到 MaxKB 公众号配置窗口中，并保存。
:::
![公众号信息](/img/maxkb/app/public_account_setting2.png)
...
![公众号信息](/img/maxkb/app/public_account_setting_url.png)

:::note

开启客服接口权限。
:::
![客服接口权限](/img/maxkb/app/public_account_enable_api.png)

:::note

设置 IP 白名单：进入公众号基本配置的【IP 白名单】中，添加 MaxKB 服务器的 IP 地址。
:::
![公众号IP白名单](/img/maxkb/app/public_account_ip.png)
...
:::
![钉钉机器人对话](/img/maxkb/app/ding_dialog1.png)
...
![钉钉机器人创建](/img/maxkb/app/dingding_setting.png)
...
![钉钉机器人创建](/img/maxkb/app/dingding_robot_create.png)
...
![钉钉智能体信息](/img/maxkb/app/dingding_info.png)
...
![钉钉智能体信息](/img/maxkb/app/dingding_setting2.png)

:::note

点击【添加智能体能力】，选择 【机器人】能力，点击 【添加】，输入机器人基本配置信息后，将【消息接收模式】设置为 HTTP 模式，并将 MaxKB 钉钉智能体配置中的回调地址的URL填写到消息接收地址中，然后点击【发布】。
:::
![钉钉机器人添加](/img/maxkb/app/dingding_robot_add.png)
![钉钉机器人息接收模式](/img/maxkb/app/dingding_msg_recvmode.png)
...
<img alt="钉钉对话" src="/img/maxkb/app/dingding_dialog.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>
...
:::
<img alt="飞书对话" src="/img/maxkb/app/feishu_dialog1.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>
...
![飞书智能体配置](/img/maxkb/app/feishu_setting.png)

:::note

创建飞书机器人：首先在 [飞书开发平台](https://open.feishu.cn/app/)的【企业自建智能体】中，点击【创建企业自建智能体】，填写智能体信息。
:::
![飞书添加机器人](/img/maxkb/app/feishu_create_app.png)

:::note

点击【添加智能体能力】，选择 【按能力添加-机器人】，点击【添加】
:::
![飞书添加机器人](/img/maxkb/app/feishu_add_robot.png)
...
![飞书token](/img/maxkb/app/feishu_verify_token.png)
...
![飞书事件与回调](/img/maxkb/app/maxkb_feishu_config.png)

:::note

配置回调URL：在飞书开放平台中打开【事件与回调】-【回调配置】的订阅方式中，将MaxKB中飞书智能体的回调地址的URL填写到【请求地址】中。
:::
![飞书事件与回调](/img/maxkb/app/feishu_event_config1.png)

![飞书事件与回调](/img/maxkb/app/feishu_event_config2.png)

:::note

发布智能体：点击【创建版本】，填写版本信息后，点击【保存】。
:::
![飞书智能体发布](/img/maxkb/app/feishu_app_create1.png)

![飞书智能体发布](/img/maxkb/app/feishu_app_create2.png)

:::note

确认发布后，智能体状态将更新为`已启用`。
:::
![飞书智能体发布](/img/maxkb/app/feishu_app_enabled.png)
...
<img alt="飞书对话" src="/img/maxkb/app/feishu_app_search.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>   <img alt="飞书对话" src="/img/maxkb/app/feishu_dialog.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>
