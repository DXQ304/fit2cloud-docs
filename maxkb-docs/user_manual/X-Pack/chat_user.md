...
![创建对话用户](/img/maxkb/system/create_chatuser.png)
...
![编辑对话用户](/img/maxkb/system/edit_chatuser.png)
...
![修改密码对话用户](/img/maxkb/system/edit_usermessage.png)
...
![设置用户组](/img/maxkb/system/set_usergaroup.png)
...
![同步对话用户](/img/maxkb/system/synchronize_users.png)
...
![删除用户组](/img/maxkb/system/chatgroup_set.png)
...
![创建用户组](/img/maxkb/system/create_group.png)
...
![删除用户组](/img/maxkb/system/delete_group.png)
...
![添加对话用户](/img/maxkb/system/add_groupuser.png)
...
:::
![登录认证](/img/maxkb/system/chat_authentication.png)
...
![登录认证](/img/maxkb/system/chat_authentication2.png)
...
![登录认证](/img/maxkb/system/QR_code.png)
...
![企业微信免密](/img/maxkb/system/wechat_login_auth.png)
...
![企业微信配置](/img/maxkb/system/trusted_domain.png)
...
![企业微信配置](/img/maxkb/system/qiwei_oauth2_login.png)
...
:::
![钉钉免密](/img/maxkb/system/dingding_login_auth.png)
...
![钉钉应用配置](/img/maxkb/system/dingding_url_set.png)
...
:::
![钉钉安全配置](/img/maxkb/system/dingding_save_setting.png)
...
注意：该地址是在【系统管理】-【对话用户】-【登录认证】-【扫码登录】中，钉钉的回调地址。
:::
![钉钉安全配置](/img/maxkb/system/dingding_share_setting.png)
...
![钉钉安全配置](/img/maxkb/system/dingding_display.png)
...
![飞书免密](/img/maxkb/app/feishu_login_auth.png)
...
- AppID：飞书应用的 App ID
:::
![飞书页面应用配置](/img/maxkb/system/feishu_web_set.png)
...
![飞书安全配置](/img/maxkb/system/feishu_security_set.png)
...
![飞书安全配置](/img/maxkb/system/feishu_display.png)
...
![登录认证](/img/maxkb/system/chat_user_dataset.png)

![登录认证](/img/maxkb/system/chat_user_app.png)