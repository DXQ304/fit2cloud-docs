...
![复制工具](/img/maxkb/fx/copy_tool.png)

![复制工具](/img/maxkb/fx/copy_tool1.png)
...
![资源授权](/img/maxkb/fx/resource_tool.png)
...
![触发器](/img/maxkb/fx/add_trigger_tool.png)
...
![创建触发器](/img/maxkb/fx/trigger_tool.png)
![创建触发器](/img/maxkb/fx/webhook_trigger.png)
...
![查看关联资源](/img/maxkb/fx/relate_resource_tool.png)
...
![查看执行记录](/img/maxkb/fx/record_tool.png)
...
![转移资源](/img/maxkb/fx/move_tool.png)
...
![函数导出](/img/maxkb/fx/import_export_dx.png)
...
![函数导入](/img/maxkb/fx/import_fx.png)
...
![函数导入成功](/img/maxkb/fx/import_success_fx.png)
...
![删除工具](/img/maxkb/fx/del_tool.png)
...
![智能体引用已删除工具](/img/maxkb/fx/use_del_tool.png)

## 9 批量选择

点击批量选择，可以批量选择工具进行移动或删除操作。

![批量操作](/img/maxkb/fx/batch_operation_tool.png)
