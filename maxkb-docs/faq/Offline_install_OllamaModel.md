...
```
:::
![下载模型](/img/maxkb/FAQ/downModel.png)
...
![模型参数模版](/img/maxkb/FAQ/modelSetting.png)
...
![ollama查看模型列表](/img/maxkb/FAQ/ollamaList.png)

## 5 在 MaxKB 中添加已创建的私有模型

![MaxKB中添加模型](/img/maxkb/FAQ/MaxKBaddModel.png)