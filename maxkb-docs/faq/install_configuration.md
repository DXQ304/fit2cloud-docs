...
![pgsl默认访问规则](/img/maxkb/FAQ/lcoal_pgsql.png)
...
![pgsl默认访问规则](/img/maxkb/FAQ/expose_pgsql_config.png)

![pgsl默认访问规则](/img/maxkb/FAQ/expose_pgsql.png)
...
![无法执行powershell脚本](/img/maxkb/FAQ/error1.png)
:::note
...
### 5.2 执行脚本后出现乱码报错
![执行powershell脚本乱码](/img/maxkb/FAQ/error2.png)
:::note

用记事本打开文件，将文件另存为 ANSI 格式的文本。
:::
![解决方法](/img/maxkb/FAQ/solution1.png)
:::note

重新执行 PowerShell 即可正常执行迁移命令。
:::
![解决方法](/img/maxkb/FAQ/solution2.png)
...
:::
![解决方法](/img/maxkb/FAQ/Path%20missing.png)
:::note
...
![解决方法](/img/maxkb/FAQ/solution3.png)