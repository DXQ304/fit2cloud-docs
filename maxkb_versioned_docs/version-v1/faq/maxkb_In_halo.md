...
![halo](/img/maxkb-v1/FAQ/halo.png)
...
:::
![下载插件](/img/maxkb-v1/FAQ/halo_install.PNG)

:::note

当前提供了 MaxKB 插件的各版本资源，请根据实际需求选择并下载所需的对应版本。
:::
![选择版本](/img/maxkb-v1/FAQ/halo_mk.PNG)
...
:::
![导入lic](/img/maxkb-v1/FAQ/halo_lic.PNG)
...
:::
![配置](/img/maxkb-v1/FAQ/halo_set.PNG)
...
注意：完成后务必保存相关设置。
:::
![配置](/img/maxkb-v1/FAQ/halo_api.PNG)

:::note

根据实际需求，完成展示设置的信息填写与同步设置的选项勾选操作。
:::
![配置](/img/maxkb-v1/FAQ/halo_choose.png)

:::note

在展示设置中，可将 MaxKB 应用配置为浮窗模式。该应用为同步获取的应用，可通过下拉框选择其在门户页面以浮窗模式展示。
:::
![配置](/img/maxkb-v1/FAQ/halo_float_win.png)

:::note

在展示设置中选定的 MaxKB 应用，将以浮窗模式呈现在 Halo 系统的首页面。
:::
![配置](/img/maxkb-v1/FAQ/halo_float_win1.png)
...
:::
![同步规则](/img/maxkb-v1/FAQ/halo_rule.png)

:::note

点击「保存」按钮即可确认当前设置并生效。
:::
![同步规则](/img/maxkb-v1/FAQ/halo_rule1.png)
...
:::
![同步日志](/img/maxkb-v1/FAQ/halo_log.png)
...
:::
![门户页面](/img/maxkb-v1/FAQ/halo_portal.png)

:::note

点击对应应用的「设置」选项，可在配置界面中完成该应用的分组管理及权限控制操作。
:::
![门户页面](/img/maxkb-v1/FAQ/halo_portal1.png)

:::note

点击页面右上角的「前台」选项，进入后可查看并访问 MaxKB 应用生态中的全部可用应用资源。
:::
![门户页面](/img/maxkb-v1/FAQ/halo_portal2.png)
