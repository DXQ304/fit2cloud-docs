...
![选择应用类型](/img/maxkb-v1/app/app_workflow.png)
...
![默认画布](/img/maxkb-v1/app/defult_workflow.png)
...
![编排画布](/img/maxkb-v1/app/workflow.png)
...
<img alt="开始节点" src="/img/maxkb-v1/app/start_node.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="开始节点-文件上传" src="/img/maxkb-v1/app/upload_config.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="开始节点-用户输入" src="/img/maxkb-v1/app/user_input.png" width="600" style={{maxWidth:'100%', height:'auto'}}/>
...
![开始节点-用户输入](/img/maxkb-v1/app/app_start.png)
...
![AI对话](/img/maxkb-v1/app/ai_chat.png)
...
![图片理解](/img/maxkb-v1/app/picture_extract.png)
...
- 历史聊天记录：
    ...
    - 选择节点：会使用当前图片节点的提示词信息和节点返回的内容作为上下文；
...
:::
![知识库检索](/img/maxkb-v1/app/dataset_search.png)    
...
:::
![多路召回](/img/maxkb-v1/app/rerank.png)
...
:::
![判断器](/img/maxkb-v1/app/condition_statement.png)
...
![指定回复](/img/maxkb-v1/app/direct_reply.png)
...
![表单收集](/img/maxkb-v1/app/form.png)
...
:::
![问题优化](/img/maxkb-v1/app/question_opt.png)  
...
![文档内容提取](/img/maxkb-v1/app/doc_extract.png)
...
<img alt="变量赋值" src="/img/maxkb-v1/app/reset_var.png" width="280" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="MCP 节点" src="/img/maxkb-v1/app/mcp.png" width="280" style={{maxWidth:'100%', height:'auto'}}/>
...
在高级编排流程中，可以添加函数库函数作为流程中的一个处理节点，以灵活处理复杂需求，函数详细说明见：[函数 ](../fx/fx)。
:::

![添加函数](/img/maxkb-v1/app/app_function.png)
...
![添加函数](/img/maxkb-v1/app/app_subapp.png)
...
<img alt="执行条件" src="/img/maxkb-v1/app/node_condition.png" width="280" style={{maxWidth:'100%', height:'auto'}}/>
...
![调试预览](/img/maxkb-v1/app/workflow_view.png)
...
![执行详情](/img/maxkb-v1/app/exec_detail.png)
...
![自动保存](/img/maxkb-v1/app/auto_save.png)
