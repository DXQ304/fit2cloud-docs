...
![显示设置](/img/maxkb-v1/app/ent_wechat_setting.png)
...
![企业ID](/img/maxkb-v1/app/enterprise_id.png)
...
![创建企业微信应用](/img/maxkb-v1/app/create_robot.png)
![企业微信应用设置](/img/maxkb-v1/app/robot_info.png)
...
![Agentid](/img/maxkb-v1/app/Agentid.png)
...
![设置API接收](/img/maxkb-v1/app/recmsg_api.png)
...
![设置API接收](/img/maxkb-v1/app/recmsg_api_setting.png)
...
![企业微信对话](/img/maxkb-v1/app/creditable_ip.png)  
...
![企业微信对话](/img/maxkb-v1/app/enter_wechat_dialog.png)
...
<img alt="企业微信客服账号" src="/img/maxkb-v1/app/weichat_customservice.png" width="800" style={{maxWidth:'100%', height:'auto'}}/>

<img alt="企业微信客服账号" src="/img/maxkb-v1/app/create_cs_account.png" width="800" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="企业微信客服账号" src="/img/maxkb-v1/app/cs_app.png" width="800" style={{maxWidth:'100%', height:'auto'}}/>

<img alt="企业微信客服账号" src="/img/maxkb-v1/app/config_cs_account.png" width="800" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="企业微信客服账号" src="/img/maxkb-v1/app/enable_cs.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>

<img alt="企业微信客服账号" src="/img/maxkb-v1/app/dialog_cs.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>
...
:::
![公众号配置](/img/maxkb-v1/app/public_account_setting_empty.png)

:::note

（2）获取 APP ID、APP Secret、Token 和消息加解密密钥：在微信公众平台-设置与开发-基本配置中获取 APP ID、APP Secret 信息，并启动服务器配置，生成 Token 和消息加解密密钥。
:::
![公众号信息](/img/maxkb-v1/app/public_account_basicinfo.png)
![公众号信息](/img/maxkb-v1/app/public_account_setting1.png)

:::note

（3）将生成的 APP ID、APP Secret、Token 和消息加解密密钥信息输入到 MaxKB 公众号配置窗口中，并保存。
:::
![公众号信息](/img/maxkb-v1/app/public_account_setting2.png)

:::note

（4）回到第（2）步，将【公众号-基本配置-服务器配置】中的 URL 设置为 MaxKB 公众号配置窗口中的回调地址 URL，然后提交，并启用服务器配置。
:::
![公众号信息](/img/maxkb-v1/app/public_account_setting_url.png)

:::note

（5）开启客服接口权限。
:::
![客服接口权限](/img/maxkb-v1/app/public_account_enable_api.png)

:::note

（6）设置IP白名单：进入公众号基本配置的【 IP 白名单】中，添加 MaxKB 服务器的 IP 地址。
:::
![公众号IP白名单](/img/maxkb-v1/app/public_account_ip.png)
...
<img alt="公众号对话" src="/img/maxkb-v1/app/public_account_dialog.jpeg" width="500" style={{maxWidth:'100%', height:'auto'}}/>
...
![飞书应用配置](/img/maxkb-v1/app/feishu_setting.png)

:::note

（2）创建飞书机器人：首先在 [飞书开发平台](https://open.feishu.cn/app/)的【企业自建应用】中，点击【创建企业自建应用】，填写应用信息。
:::
![飞书添加机器人](/img/maxkb-v1/app/feishu_create_app.png)

:::note

点击【添加应用能力】，选择 【按能力添加-机器人】，点击【添加】
:::
![飞书添加机器人](/img/maxkb-v1/app/feishu_add_robot.png)
...
![飞书token](/img/maxkb-v1/app/feishu_verify_token.png)
...
![飞书事件与回调](/img/maxkb-v1/app/maxkb_feishu_config.png)

:::note

（6）配置回调 URL：在飞书开放平台中打开【事件与回调】-【回调配置】的订阅方式中，将 MaxKB 中飞书应用的回调地址的 URL 填写到【请求地址】中。
:::
![飞书事件与回调](/img/maxkb-v1/app/feishu_event_config1.png)

![飞书事件与回调](/img/maxkb-v1/app/feishu_event_config2.png)

:::note

（7）发布应用：点击【创建版本】，填写版本信息后，点击【保存】。
:::
![飞书应用发布](/img/maxkb-v1/app/feishu_app_create1.png)

![飞书应用发布](/img/maxkb-v1/app/feishu_app_create2.png)

:::note

确认发布后，应用状态将更新为`已启用`。
:::
![飞书应用发布](/img/maxkb-v1/app/feishu_app_enabled.png)
