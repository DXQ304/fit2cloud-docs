...
:::
![LDAP](/img/maxkb-v1/system/LDAP.png)
...
:::
![CAS](/img/maxkb-v1/system/CAS.png)
...
:::
![OIDC](/img/maxkb-v1/system/OIDC.png)
...
:::
![OAHTU2](/img/maxkb-v1/system/oauth2.png)
...
:::
![打开后台](/img/maxkb-v1/system/qiwei_open_backend.png)
![复制企业ID](/img/maxkb-v1/system/qiwei_open_bakend1.png)
...
![企微应用创建](/img/maxkb-v1/system/qiwei_create_app.png)

![企微应用信息](/img/maxkb-v1/system/qiwei_appinfo.png)

:::note

第二步：设置可信域名。在【开发者接口】中点击【设置可信域名】，添加可信域名，并进行校验。
:::
![设置可信域名](/img/maxkb-v1/system/qiwei_yuming.png)

:::note

第三步：授权回调域。在【企业微信授权】中设置授权回调域。
:::
![设置回调域](/img/maxkb-v1/system/qiwei_callback.png)

:::note

第四步：配置企业可信 IP。在【企业可信 IP】中配置可信 IP。
:::
![配置可信IP](/img/maxkb-v1/system/qiwei_ip.png)

:::note

完成企业微信应用的配置和发布后，在 MaxKB 企业微信登录扫码配置页面配置相应信息并通过效验。
:::
![企业微信配置](/img/maxkb-v1/system/qiwei_setting.png)
...
![企业微信配置](/img/maxkb-v1/system/weichat_oauth2.png)
...
:::
![钉钉创建应用](/img/maxkb-v1/system/dingding_app_create.png)
![钉钉应用信息](/img/maxkb-v1/system/dingding_app_info.png)

:::note

第二步：进入到【权限管理】中，添加如下图所示的权限即可。
:::
![钉钉应用添加权限](/img/maxkb-v1/system/dingding_permissions.png)

:::note

第三步：在【版本管理与发布】中，填写应用版本号、版本描述等信息，点击【保持】，发布应用。
:::
![钉钉应用信息](/img/maxkb-v1/system/dingding_app_release.png)

:::note

完成配置后发布，然后在 MaxKB 钉钉扫码登录扫码配置页面进行配置并保存。
:::
![钉钉创建应用](/img/maxkb-v1/system/dingding_setting.png)
...
![钉钉创建应用](/img/maxkb-v1/system/dingding_add_webapp.png)

![钉钉应用配置](/img/maxkb-v1/system/dingding_webapp_config.png)

:::note

第二步：安全设置。在【安全设置】中设置重定向 URL 和端内免登录地址。
:::
![钉钉安全配置](/img/maxkb-v1/system/dingding_security_config.png)

:::note

第三步：分享设置，在【接入登录】中设置【回调域名】。
:::
![钉钉安全配置](/img/maxkb-v1/system/dingding_share_config.png)
...
![飞书配置](/img/maxkb-v1/system/feishu_setting.png)
...
:::
![飞书创建](/img/maxkb-v1/system/feishu_create_app.png)

:::note

第二步：配置重定向 URL。在【开发配置-安全设置】中，输入 MaxKB 飞书扫码配置弹出框中的回调地址，点击【添加】。
:::
![飞书配置回调URL](/img/maxkb-v1/system/feishu_url.png)

:::note

第三步：发布应用。在【版本管理与发布】中，输入应用版本号、更新说明等信息，点击【保存】，完成应用发布。
:::
![飞书发布应用](/img/maxkb-v1/system/feishu_app_release.png)
...
![飞书添加页面应用](/img/maxkb-v1/system/feishu_add_webapp.png)
![飞书页面应用配置](/img/maxkb-v1/system/feishu_webapp_config.png)
...
![飞书安全配置](/img/maxkb-v1/system/feishu_security_config.png)
