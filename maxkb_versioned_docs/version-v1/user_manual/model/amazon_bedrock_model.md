...
<img alt="AWS LLM模型" src="/img/maxkb-v1/model/AWS_LLM.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>
...
<img alt="AWS LLM模型" src="/img/maxkb-v1/model/aws_embed.png" width="500" style={{maxWidth:'100%', height:'auto'}}/>