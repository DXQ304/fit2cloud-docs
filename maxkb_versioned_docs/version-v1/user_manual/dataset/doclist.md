...
![上传文档](/img/maxkb-v1/dataset/create_offline_dataset.png)
...
![智能分段](/img/maxkb-v1/dataset/auto_paragraph.png)
...
![导入Web文档](/img/maxkb-v1/dataset/upload_web_doc.png)
...
![同步知识库](/img/maxkb-v1/dataset/sysn_dataset.png)
...
![同步文档](/img/maxkb-v1/dataset/sysn_web_doc.png)
...
![文档设置](/img/maxkb-v1/dataset/doc_setting.png)
...
![生成问题](/img/maxkb-v1/dataset/gen_question.png)
...
![迁移文档](/img/maxkb-v1/dataset/move_web_doc.png)
...
![文档导出](/img/maxkb-v1/dataset/dataset_file_export.png)
...
![文档删除](/img/maxkb-v1/dataset/doc_delete.png)
...
![文档启用](/img/maxkb-v1/dataset/doc_enable.png)
...
![分段管理](/img/maxkb-v1/dataset/segmentation_management.png)
...
![添加分段](/img/maxkb-v1/dataset/add_segmentation.png)
...
:::
![分段详情](/img/maxkb-v1/dataset/edit_segmentation.png)
...
![迁移分段](/img/maxkb-v1/dataset/move_segmentation.png)
...
![删除分段](/img/maxkb-v1/dataset/del_segmentation.png)
