...
![dataset](/img/maxkb-v1/dataset/create.jpg)
...
![智能分段](/img/maxkb-v1/dataset/automatic_paragraphing.png)
...
![高级分段](/img/maxkb-v1/dataset/advanced_segmentation.png)
:::note
...
:::
![设置标题为关联问题](/img/maxkb-v1/dataset/titel_set_question.png)
...
:::
![分段预览](/img/maxkb-v1/dataset/preview_segmentation.png)
:::note

在分段预览中对不合理的分段进行再次编辑以及删除无意义分段。
:::
![编辑分段](/img/maxkb-v1/dataset/view_edit.png)
...
:::
![编辑分段](/img/maxkb-v1/dataset/processing.png)
...
![Web知识库](/img/maxkb-v1/dataset/web_dataset.png)
...
![Alt text](/img/maxkb-v1/dataset/DataEase_doc.png)
:::note

点击【创建并导入】后，跳转到文档列表页面查看当前 Web 站点下文档的详细信息，处理结束后，文件状态将显示为完成。
:::

![Alt text](/img/maxkb-v1/dataset/web_doc.png)
...
![知识库导出](/img/maxkb-v1/dataset/dataset_actions.png)
...
:::
![知识库导出](/img/maxkb-v1/dataset/web_%20sync.png)
...
![知识库导出](/img/maxkb-v1/dataset/dataset_embedding.png)
...
:::
![知识库设置页面](/img/maxkb-v1/dataset/dataset_setting.png)
...
**注意**：知识库删除后无法恢复，请谨慎操作。
:::
![知识库删除](/img/maxkb-v1/dataset/dataset_del.png)
