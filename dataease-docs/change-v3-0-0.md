...
安装器默认仍拉起内置 MySQL 8.4.5。需要改用其他库时，详见 [外部数据库部署](./installation/multi_database_deployment)。
:::
...
<img alt="电子表格" src="/img/dataease/newimg/电子表格门店数据展示.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
