...
- **邮箱**：用户邮箱；
- **手机**：用户手机号；
- **系统变量**：可为该用户添加系统变量参数，见 [系统变量](./system_variables)；
...
系统管理员可在【系统设置-权限配置】中，通过【用户】维度为个人分配菜单/资源权限，通过【角色】维度配置资源权限。组织内的自定义角色，以及按角色分配菜单，请在【组织管理中心】中处理，见 [成员管理](./org_center_member)。
:::
