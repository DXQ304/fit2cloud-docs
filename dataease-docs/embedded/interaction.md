...
使用外部参数，需要先在 DataEase 系统中设置好数据大屏或者仪表板外部参数，具体设置可见[操作手册](../user_manual/dashboard_basicfunctions)。
:::
<img alt="3.3.2 外部参数设置.png" src="/img/dataease/embedded/3.3.2%20外部参数设置.png" width="900" style={{maxWidth:'100%', height:'auto'}}/>
